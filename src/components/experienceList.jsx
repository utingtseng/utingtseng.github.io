const experienceList = [
    {  
        ...
        id: 2,
        institution: "Blakbear",
        startTime:"Jun 2022",
        endTime:"Jul 2023",
        description:"R&D Engineer - Prototyping IoT products in C++ (Arduino) and building data collection pipeline on GCP.",
        skills:["Python", "GCP", "SQL (BigQuery)", "C++ (Arduino)", "Git"],
        secondarySkills: ["Web development", "Electronics"],
        color:"7ae7c7"
    }, {  
        id: 3,
